...
import com.atschoolPioneerSchool.adapter.AttendanceListAdapter;
 ...
 */
public class activity_school_register_attendance extends AppCompatActivity {
    /**
    ...
    public AttendanceListAdapter mAdapter;
    ...
    public EditText edt_datefrom;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);

        setContentView(R.layout.activity_school_register_attendance);
        ...
        CLASS_SECTION_ID = sharedpref.getString("CLASS_SECTION_ID", "").trim();
            ...
            public void onClick(View v) {
                DatePickerDialog d = new DatePickerDialog(v.getContext(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                        ...
                        edt_datefrom.setText(String.valueOf(year) + "-" + month + "-" + day);
                        ...
                        if (Datestr.length() == 8) {
                            ...
                            if (!isNetworkAvailable(getBaseContext())) {
                                ...
                                new activity_school_register_attendance.GetDataTask(view.getContext()).execute("");
                            }
                        }
                    }
                ...
                d.setTitle("Select Date From");
                d.show();
            }
        });

        edt_datefrom.performClick();

    }


    private class GetDataTask extends AsyncTask<String, Attendance, String> {
        ...
        //http://schoolrootweb.controporal.com/API_Mobile.aspx?events=12&ClassSection_Id=375099&DT=20170609
        String tag[] = {"events", "ClassSection_Id", "DT"};
        String value[] = {"12", CLASS_SECTION_ID, Datestr};
                    ...
                    if (!json_code.equals("")) {
                        ...
                        if (jsonArray.length() > 0) {
                            ...
                            for (i = 0; i < cntall; i++) {
                                ...
                                try {
                                    ...
                                    if (Message_Id > 0) {
                                        ...
                                        Attendance objGrade = new Attendance(i + 1, json.getLong("RowNumber"), json.getInt("StudentId"), json.getString("NameAsInPass"), json.getString("NameAsPassEng")
                                                , json.getString("FNameA"), json.getBoolean("Absence"), json.getBoolean("Delay"), json.getString("Datestr")
                                                , json.getString("GCM_Token"), json.getString("GardianResidencyNo"), json.getString("USER_MASTER_Id"), false);
                           ...
                           //add last row the balance
                            if (Message_Id == 0) {
                                Attendance objGrade = new Attendance(i + 1, 0, "", "", 0, 0,0, 0, Balance, "", "","", "", "", "", true);
        ...
        @Override
        protected void onProgressUpdate(Attendance... values) {
        ...
        protected void onPostExecute(String msg) {
            ...
            mAdapter = new AttendanceListAdapter(mContext, items);
