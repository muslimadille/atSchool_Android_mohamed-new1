...
public class ActivityTestSelectFile extends AppCompatActivity {

    // LogCat tag
    private static final String TAG = ActivityTestSelectFile.class.getSimpleName();
    ...
    private Button btnCapturePicture, btnRecordVideo, btnSelectFile;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_test_select_file);
        ...
        btnSelectFile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                FilePickerDialog dialog = new FilePickerDialog(ActivityTestSelectFile.this, properties);
    ...
    private void launchUploadActivity(boolean isImage) {
        Intent i = new Intent(ActivityTestSelectFile.this, ActivityTestUpload.class);
