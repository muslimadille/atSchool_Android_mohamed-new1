...
import com.atschoolPioneerSchool.widget.RoundedTransformation;
...
public class ItemGridAdapter extends RecyclerView.Adapter<ItemGridAdapter.ViewHolder> implements Filterable {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View v) {
            ...
            img_heart = (ImageView) v.findViewById(R.id.img_heart);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.like.setText(p.getDescription());
        holder.price.setText(p.getStrPrice());

        if (p.isKid) {
            if (!p.StudentImageName.equals("")) {
                ...
                ImageLoader.getInstance().displayImage(ctx.getString(R.string.URL_Account_Profile_Images) + String.valueOf(p.StudentImageName)
