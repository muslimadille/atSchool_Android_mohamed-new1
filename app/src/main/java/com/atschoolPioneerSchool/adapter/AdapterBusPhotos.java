...
public class AdapterBusPhotos extends BaseAdapter {
    ...
    public AdapterBusPhotos(Context context, List<MessageDetails> messages) {
        super();
        this.ctx = context;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        final AdapterBusPhotos.ViewHolder holder;
        if (convertView == null) {
            holder = new AdapterBusPhotos.ViewHolder();
            convertView = LayoutInflater.from(ctx).inflate(R.layout.row_bus_photos, parent, false);
            ...
            holder = (AdapterBusPhotos.ViewHolder) convertView.getTag();
        }
        ...
        ImageLoadingListener animateFirstListener = new AdapterBusPhotos.AnimateFirstDisplayListener();
...
//  video info
        if (msg.Attached_File_Extension.equals(".mp4")) {
           ...
           /*     ImageLoader.getInstance().displayImage(ctx.getString(R.string.URL_ChatUploads_Images) + String.valueOf(msg.Attached_File_Name)
                ...
                ImageLoader.getInstance().displayImage(String.valueOf(msg.Attached_File_Name)
                        , holder.image, options, animateFirstListener);
        ...
        holder.image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (msg.Attached_File_Extension.equals(".mp4")) {
                    ...
                    edtPref.putString("VideoURL", view.getResources().getString(R.string.URL_ChatUploads_Images) + msg.Attached_File_Name);
                    edtPref.commit();
                    ...
                    if (msg.Attached_File_Extension.equals(".jpg") || msg.Attached_File_Extension.equals(".gif") || msg.Attached_File_Extension.equals(".png") ||
                        ...
                        String ImagePath = msg.Attached_File_Name;
                    ...
                    } else //this mean attached documents
                    {
                        ...
                        AdapterBusPhotos.MyDownloadDownloadStatusListenerV1 myDownloadStatusListener = new AdapterBusPhotos.MyDownloadDownloadStatusListenerV1(holder.mProgress1Txt, holder.mProgress1, position);
        ...
        /* if (msg.isFromMe()) {*/
        holder.lyt_parent.setPadding(40, 10, 40, 10);
