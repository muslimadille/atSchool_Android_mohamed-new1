...
public class StatementListAdapter extends RecyclerView.Adapter<StatementListAdapter.ViewHolder> implements Filterable {

    private List<Statement> original_items = new ArrayList<>();
    private List<Statement> filtered_items = new ArrayList<>();
    ...
    public StatementListAdapter(Context ctx, List<Statement> items) {
        this.ctx = ctx;
    ...
    public StatementListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        // create a new view
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_statement, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        final Statement n = filtered_items.get(position);
        ...
        if (!n.LastObject) {
            ...
            holder.Account.setText("  " + n.ACCOUNTS_NAMEA);
...
//                .into(holder.image);
            ...
            holder.content.setText(Html.fromHtml("الرصيد   " + "   " + n.Balance + "        "));
            holder.date.setText("  ");
    ...
    private class ItemFilter extends Filter {
        ...
        protected FilterResults performFiltering(CharSequence constraint) {
            ...
            final List<Statement> list = original_items;
            final List<Statement> result_list = new ArrayList<>(list.size());
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            filtered_items = (List<Statement>) results.values;
