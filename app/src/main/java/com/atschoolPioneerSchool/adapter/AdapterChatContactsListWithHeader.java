...
public class AdapterChatContactsListWithHeader extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private AdapterChatContactsListWithHeader.OnItemClickListener mOnItemClickListener;

    public interface OnItemClickListener {
        void onItemClick(View view, ChatContacts obj, int position);
    }

    public void setOnItemClickListener(final AdapterChatContactsListWithHeader.OnItemClickListener mItemClickListener) {
        this.mOnItemClickListener = mItemClickListener;
    }

    // Provide a suitable constructor (depends on the kind of dataset)
    public AdapterChatContactsListWithHeader(Context context, ChatContacts header, List<ChatContacts> items) {
        this.items = items;
        this.header = header;
        ctx = context;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_HEADER) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chat_contacts, parent, false);
            return new AdapterChatContactsListWithHeader.ViewHolderHeader(v);
        } else if (viewType == TYPE_ITEM) {
            View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_chat_contacts, parent, false);
            return new AdapterChatContactsListWithHeader.ViewHolder(v);
        }
        return null;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof AdapterChatContactsListWithHeader.ViewHolderHeader) {
            AdapterChatContactsListWithHeader.ViewHolderHeader vHeader = (AdapterChatContactsListWithHeader.ViewHolderHeader) holder;
        ...
        } else if (holder instanceof AdapterChatContactsListWithHeader.ViewHolder) {
            final ChatContacts c = items.get(position);
            AdapterChatContactsListWithHeader.ViewHolder vItem = (AdapterChatContactsListWithHeader.ViewHolder) holder;
        ...
        /*    DisplayImageOptions options = new DisplayImageOptions.Builder()
            ...
            ImageLoadingListener animateFirstListener = new AdapterChatContactsListWithHeader.AnimateFirstDisplayListener();
