...
public class ChatFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_friend_activities, null);
        ...
        if (!isNetworkAvailable(getActivity().getBaseContext())) {
            ...
            myTask = new ChatFragment.GetDataTask(getContext());
            myTask.execute("");
        }
        ...
        protected String doInBackground(String... strings) {
            try {
                ...
                try {
                    ...
                    String tag[] = {"events", "NumberRowsInGrid", "SelectedPageNumer", "USER_MASTER_Id", "USER_TYPE_Id", "USER_NAME"};
                    String value[] = {"26", "25", "0", USER_MASTER_Id, USER_TYPE_Id, SearchText};
                    items = new ArrayList<>();
                            ...
                            for (i = 0; i < cntall; i++) {
                                ...
                                try {
                                    ...
                                    ChatContacts objChat = new ChatContacts(
                                            json.getString("Id"), json.getString("USER_NAME"), json.getString("USER_NAME_A"),
                                            json.getString("NickName"), json.getString("USER_CODE"), json.getString("Profile_Picture"), "",
                                            json.getString("RowNumber"), "13", ChannelName, json.getString("GCM_Token"), json.getString("APNS_Token"),
                ...
                if (!this.isCancelled()) {
                    ...
                    mAdapter.setOnItemClickListener(new AdapterChatContactsListWithHeader.OnItemClickListener() {
                        ...
                        public void onItemClick(View v, ChatContacts obj, int position) {
                            ...
                            friend.APNS_Token = obj.APNS_Token;
